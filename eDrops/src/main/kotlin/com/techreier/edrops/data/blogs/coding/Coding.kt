...
object Coding : Blogs {
    ...
    const val SUMMARY_NO = "Denne bloggen inneholder korte innlegg om koding – kunsten å få datamaskiner til å gjøre som du vil. " +
    ...
    const val SUMMARY_EN = "This blog contains short posts about coding – the art of making computers do what you want. " +
