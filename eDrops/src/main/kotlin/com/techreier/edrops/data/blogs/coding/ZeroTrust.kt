...
"""
    ...
    override fun no(blog: Blog): BlogPost {
        logger.info("Ascii: \nascii(SUMMARY_NO)")
        return BlogPost(timestamp, SEGMENT, TITLE_NO, SUMMARY_NO.strip(), blog)

    }

    override fun en(blog: Blog): BlogPost = BlogPost(
        timestamp, SEGMENT, TITLE_EN,
        SUMMARY_EN.strip(), blog
    )
