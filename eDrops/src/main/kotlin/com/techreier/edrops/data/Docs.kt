...
object Docs {
    ...
    val about =
        arrayOf(
            ...
            MenuItem("readme", c.codingNo, "README"),
            MenuItem("readme", c.codingEn, "README"),
            ...
            MenuItem("gui", c.codingNo, "GUI design"),
            MenuItem("gui", c.codingEn, "GUI design"),
            MenuItem("state", c.codingNo, "Web apps og tilstand"),
            MenuItem("state", c.codingEn, "Web apps and state"),
            MenuItem("zerotrust", c.codingNo, "Zero Trust"),
            MenuItem("zerotrust", c.codingEn, "Zero Trust"),
            MenuItem("jottacloud", c.codingNo, "Jottacloud"),
            MenuItem("jottacloud", c.codingEn, "Jottacloud"),
    ...
    val energy =
        arrayOf(
            ...
            MenuItem("energyremark", c.defaultNo, ""),
            MenuItem("energyremark", c.defaultEn, "")
        )
