...
class BlogData {
    ...
    val blogEntry1 = BlogEntry(LocalDateTime.now(), LocalDateTime.now(), TAG1, V1, TITLE1, SUMMARY1, blog1 )
    private val blogEntry2  = BlogEntry(LocalDateTime.now(), LocalDateTime.now(), TAG2, V1,  TITLE2, SUMMARY2, blog1)
    private val blogEntry3  = BlogEntry(LocalDateTime.now(), LocalDateTime.now(), TAG2, V1,  TITLE3, SUMMARY3,  blog1)
    private val blog2Entry3 = BlogEntry(LocalDateTime.now(), LocalDateTime.now(), TAG2, V1, TITLE4, SUMMARY4, blog2)
